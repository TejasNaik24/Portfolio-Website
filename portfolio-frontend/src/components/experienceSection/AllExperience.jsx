...
const experiences = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Using Google Gemini and OpenAI LLMs to create intelligent conversational agents that analyze client health data, identify patterns, and provide actionable coaching insights.",
    ],
  },
  {
